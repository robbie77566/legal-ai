...
| `DOC_CLASSIFIER_USD_FACTOR` | | Price ratio of the classifier model vs the MODEL_USD_* rates, for cost estimates | Production 0.1 (Haiku $1 vs Fable $10); dev/default 0.2 (vs Opus $5) |
