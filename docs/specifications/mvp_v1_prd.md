...
**US-12 — Promo codes (added 2026-09-01).** As the operator, I can mint text codes with a dollar amount off the $299 (up to free), capped and expirable, managed at `/ops/promos`; as a buyer I can apply one before paying and see the new total; a 100%-off code creates my case with no payment step at all. Full design, JTBD matrix, and engineering interrogation: `docs/design/promo_codes.md`.
